===============================
Welcome to python-quoine v0.3.4
===============================
...
This is an unofficial Python wrapper for the `Quoinex exchange REST API v2 <https://developers.quoine.com/v2>`_. I am in no way affiliated with Quoine, use at your own risk.
